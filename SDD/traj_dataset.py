...
class TrajDataset(dataset.Dataset):
    ...
    def __init__(self, data_folder, n_prev=4, n_next=6, img_step=10, n_traj=10, device=None,test=False):
    ...
    def process_data(self):
        ...
        raw_data[["xmin", "ymin", "xmax", "ymax"]] = self.normalize_coords(raw_data[["xmin", "ymin", "xmax", "ymax"]])
        # print(raw_data)
        ...
        for track_id in track_ids:
            ...
            for i in range(len(traj) - self.n_next - self.n_prev):
                ...
                y = traj.iloc[i + self.n_prev: i + self.n_prev + self.n_next][
                    ["xmin", "ymin", "xmax", "ymax"]]  # recuperer le grand truth à prédire
